...
def backProp_test():
    ...
    # To hidden
    g.add_edge(3,0,weight=round(random(),2))
    g.add_edge(4,0,weight=round(random(),2))
    g.add_edge(4,1,weight=round(random(),2))
    g.add_edge(4,2,weight=round(random(),2))
    g.add_edge(3,1,weight=round(random(),2))
    g.add_edge(3,2,weight=round(random(),2))
